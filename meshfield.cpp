...
static char* g_TextureName[TEXTURE_MAX] = {
	"data/TEXTURE/Snow_1_AlbedoSmoothness.png",
};
...
static bool			g_IsWaveActive = false;		// 波有効化フラグ
...
{
	fieldSize = min(nNumBlockX * fBlockSizeX, nNumBlockZ * fBlockSizeZ);
...
float GetFieldSize(void) {
	if (g_Load) {
		return fieldSize * REAL_FIELD_SIZE;
	}
