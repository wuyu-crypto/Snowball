...
/* game pad情報 */
#define BUTTON_UP		0x00000001l	// 方向キー上(.IY<0)						// 00000000000000000000000000000001
#define BUTTON_DOWN		0x00000002l	// 方向キー下(.IY>0)						// 00000000000000000000000000000010
#define BUTTON_LEFT		0x00000004l	// 方向キー左(.IX<0)						// 00000000000000000000000000000100
#define BUTTON_RIGHT	0x00000008l	// 方向キー右(.IX>0)						// 00000000000000000000000000001000
...
#define BUTTON_X		0x00000010l	// Ｘボタン(.rgbButtons[0]&0x80)			// 00000000000000000000000000010000
#define BUTTON_A		0x00000020l	// Ａボタン(.rgbButtons[1]&0x80)			// 00000000000000000000000000100000
...
#define	BUTTON_ALL		0xFFFFFFFF|	// 任意キー
